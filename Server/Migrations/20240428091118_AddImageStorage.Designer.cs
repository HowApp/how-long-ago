...
namespace How.Server.Migrations
{
    ...
    [Migration("20240428091118_AddImageStorage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("How.Core.Database.Entities.Storage.AppFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("FileHash")
                        .IsUnique()
                        .HasDatabaseName("ix_app_files_file_hash");
            ...
            modelBuilder.Entity("How.Core.Database.Entities.Storage.StorageImage", b =>
                {
                    ...
                    b.HasIndex("ImageId")
                        .HasDatabaseName("ix_storage_images_image_id");
            ...
            modelBuilder.Entity("How.Core.Database.Entities.Storage.StorageImage", b =>
                {
                    b.HasOne("How.Core.Database.Entities.Storage.AppFile", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_storage_images_app_files_image_id");

                    b.HasOne("How.Core.Database.Entities.Storage.AppFile", "Thumbnail")
                        .WithMany()
                        .HasForeignKey("ThumbnailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_storage_images_app_files_thumbnail_id");
